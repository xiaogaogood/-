      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteCartBuId(cart)"
              >删除</a
            >
            <br />
            <a href="#none">移到收藏</a>
...
export default {
  ...
  methods: {
    ...
    //cart是哪个一个产品（身上有id）
    handler: throttle(async function (type, disNum, cart) {  //修改产品个数上加上节流
      switch (type) {
        case "add":
          disNum = 1;
          break;
